...
public protocol NHRangeSliderViewDelegate: AnyObject {
    /// slider value changed
    func sliderValueChanged(slider: NHRangeSlider?)
}
extension NHRangeSliderViewDelegate {
    func sliderValueChanged(slider: NHRangeSlider?) {}
}
...
open class NHRangeSliderView: UIView {
    // MARK: - properties
    open weak var delegate: NHRangeSliderViewDelegate?
    /// Range slider
    open var rangeSlider: NHRangeSlider?
    /// Display title
...
//        self.addSubview(self.upperLabel!)
    ...
    override open func layoutSubviews() {
        ...
        if let titleLabel = self.titleLabel, let lowerLabel = self.lowerLabel ,
            ...
            if !titleLabel.isHidden && titleLabel.text != nil && !titleLabel.text!.isEmpty {
            ...
            rangeSlider.frame = CGRect(x: 0, y: titleLabelMaxY + lowerLabel.font.lineHeight + self.spacing,
                                       width: commonWidth ,
                                       height: thumbSize )
